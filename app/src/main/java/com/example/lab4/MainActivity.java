...
public class MainActivity extends AppCompatActivity {
    ...
    com.example.lab4.DataBaseHelper dataBaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBaseHelper = new com.example.lab4.DataBaseHelper (MainActivity.this);
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.example.lab4.DataBaseHelper dataBaseHelper = new DataBaseHelper(MainActivity.this);
    ...
    private void ShowStudentsOnListView(com.example.lab4.DataBaseHelper dataBaseHelper) {
